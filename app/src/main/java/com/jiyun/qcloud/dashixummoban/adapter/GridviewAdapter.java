...
public class GridviewAdapter extends BaseAdapter {
    ...
    private final List<PandaHome.DataBean.PandaliveBean.ListBean> list;

    public GridviewAdapter(Context context, List<PandaHome.DataBean.PandaliveBean.ListBean> list) {
